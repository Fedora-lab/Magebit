...
include_once('php/validateEmail.php');
 class Databases extends DbConnection{  
     ...
     function fetchdata($table_name,$order){  // takes all datafrom DB and fetches into table(essential)    
           $search=($this->search);
           if(empty($search)){
     ...
     function insertdata($table_name, $data){   // inserting data into html(essential)    
     ...
     function delete($where_condition){    
